...
import 'auto-bindings/ht_script_binding.dart';
late HT_Interpreter hetu;
void main() {
  runApp(MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Hetu/Dart Binding Test'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void test() async {
    ...
    sw.start();
    hetu = HT_Interpreter(readFileMethod: (path) {
      return rootBundle.loadString(path);
    });
    var binding = ManualBinding();
    binding.loadAutoBinding(hetu);
    print('ht binding init over');
    print('sw.elapsed: ${sw.elapsed}');
    sw.reset();
    binding.loadAutoBindingScripts(hetu, 'assets/ht').then((value) {
      print('ht script init over');
      print('sw.elapsed: ${sw.elapsed}');
      hetu.eval('''
      ...
      fun main {
        ...
        var strFuture = r.loadString('assets/data/test.td') 
